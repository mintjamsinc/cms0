 ...
 *   https://example.com/bin/cms.cgi/system/usr/share/webtop/
 * splits into:
 *   - Workspace: "system"
 *   - Webtop root path (JCR): "/usr/share/webtop"
 *
...
export interface UrlInfo {
  ...
  cmsBasePath: string;
  /** JCR path of the webtop root within the workspace (e.g. "/usr/share/webtop") */
...
export class UrlUtils {
   ...
   *   (e.g. "https://example.com/bin/cms.cgi/system/usr/share/webtop/")
   ...
   * @returns Root-relative URL (e.g. "/bin/cms.cgi/webpub/usr/share/webtop/")
   */
   ...
   *
   * @param rootPath - JCR path of the webtop root (e.g. "/usr/share/webtop")
   * @returns Apps directory path (e.g. "/usr/share/webtop/apps")
   */
