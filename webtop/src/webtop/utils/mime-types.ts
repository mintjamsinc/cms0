...
export class MimeTypes {
	static filterMimeTypes(type?: string): string[] {
		const maxCount = 999;
		const mimetypes = [
	...
	static description(type: string): string | undefined {
		const descriptions = {
	...
	static detectType(filename: string, defaultType?: string | null): string {
	...
	static detectExtension(type: string, defaultExt?: string): string {
		const exts = {
