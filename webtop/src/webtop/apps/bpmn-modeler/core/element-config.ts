...
export const ELEMENT_SUBTYPES: Record<string, SubTypeOption[]> = {
	startEvent: [
		{ label: 'app.bpmn-modeler.subtype.none', subType: 'none' },
		{ label: 'app.bpmn-modeler.subtype.message', subType: 'message', icon: 'message' },
		{ label: 'app.bpmn-modeler.subtype.timer', subType: 'timer', icon: 'timer' },
		{ label: 'app.bpmn-modeler.subtype.conditional', subType: 'conditional', icon: 'conditional' },
		{ label: 'app.bpmn-modeler.subtype.signal', subType: 'signal', icon: 'signal' },
	],
	endEvent: [
		{ label: 'app.bpmn-modeler.subtype.none', subType: 'none' },
		{ label: 'app.bpmn-modeler.subtype.message', subType: 'message', icon: 'message-filled' },
		{ label: 'app.bpmn-modeler.subtype.terminate', subType: 'terminate', icon: 'terminate' },
		{ label: 'app.bpmn-modeler.subtype.error', subType: 'error', icon: 'error' },
		{ label: 'app.bpmn-modeler.subtype.escalation', subType: 'escalation', icon: 'escalation' },
		{ label: 'app.bpmn-modeler.subtype.signal', subType: 'signal', icon: 'signal-filled' },
	],
	userTask: [
		{ label: 'app.bpmn-modeler.subtype.user', subType: 'user', icon: 'user' },
		{ label: 'app.bpmn-modeler.subtype.service', subType: 'service', icon: 'service' },
		{ label: 'app.bpmn-modeler.subtype.script', subType: 'script', icon: 'script' },
		{ label: 'app.bpmn-modeler.subtype.manual', subType: 'manual', icon: 'manual' },
		{ label: 'app.bpmn-modeler.subtype.send', subType: 'send', icon: 'send' },
		{ label: 'app.bpmn-modeler.subtype.receive', subType: 'receive', icon: 'receive' },
		{ label: 'app.bpmn-modeler.subtype.businessRule', subType: 'businessRule', icon: 'businessRule' },
		{ label: 'app.bpmn-modeler.subtype.callActivity', subType: 'callActivity', icon: 'callActivity' },
	],
	serviceTask: [
		{ label: 'app.bpmn-modeler.subtype.user', subType: 'user', icon: 'user' },
		{ label: 'app.bpmn-modeler.subtype.service', subType: 'service', icon: 'service' },
	...
	exclusiveGateway: [
		{ label: 'app.bpmn-modeler.subtype.exclusive', subType: 'exclusive', icon: 'exclusive' },
		{ label: 'app.bpmn-modeler.subtype.parallel', subType: 'parallel', icon: 'parallel' },
		{ label: 'app.bpmn-modeler.subtype.inclusive', subType: 'inclusive', icon: 'inclusive' },
		{ label: 'app.bpmn-modeler.subtype.eventBased', subType: 'eventBased', icon: 'eventBased' },
		{ label: 'app.bpmn-modeler.subtype.complex', subType: 'complex', icon: 'complex' },
	],
	parallelGateway: [
		{ label: 'app.bpmn-modeler.subtype.exclusive', subType: 'exclusive', icon: 'exclusive' },
		{ label: 'app.bpmn-modeler.subtype.parallel', subType: 'parallel', icon: 'parallel' },
	...
	intermediateEvent: [
		{ label: 'app.bpmn-modeler.subtype.none', subType: 'none', catching: true },
		{ label: 'app.bpmn-modeler.subtype.messageCatch', subType: 'message', catching: true, icon: 'message' },
		{ label: 'app.bpmn-modeler.subtype.messageThrow', subType: 'message', catching: false, icon: 'message-filled' },
		{ label: 'app.bpmn-modeler.subtype.timer', subType: 'timer', catching: true, icon: 'timer' },
		{ label: 'app.bpmn-modeler.subtype.conditional', subType: 'conditional', catching: true, icon: 'conditional' },
		{ label: 'app.bpmn-modeler.subtype.signalCatch', subType: 'signal', catching: true, icon: 'signal' },
		{ label: 'app.bpmn-modeler.subtype.signalThrow', subType: 'signal', catching: false, icon: 'signal-filled' },
		{ label: 'app.bpmn-modeler.subtype.linkCatch', subType: 'link', catching: true, icon: 'link' },
		{ label: 'app.bpmn-modeler.subtype.linkThrow', subType: 'link', catching: false, icon: 'link-filled' },
		{ label: 'app.bpmn-modeler.subtype.escalationCatch', subType: 'escalation', catching: true, icon: 'escalation' },
		{ label: 'app.bpmn-modeler.subtype.escalationThrow', subType: 'escalation', catching: false, icon: 'escalation-filled' },
		{ label: 'app.bpmn-modeler.subtype.compensationCatch', subType: 'compensation', catching: true, icon: 'compensation' },
		{ label: 'app.bpmn-modeler.subtype.compensationThrow', subType: 'compensation', catching: false, icon: 'compensation-filled' },
	],
	boundaryEvent: [
		{ label: 'app.bpmn-modeler.subtype.message', subType: 'message', icon: 'message' },
		{ label: 'app.bpmn-modeler.subtype.timer', subType: 'timer', icon: 'timer' },
		...
		{ label: 'app.bpmn-modeler.subtype.error', subType: 'error', icon: 'error' },
		{ label: 'app.bpmn-modeler.subtype.escalation', subType: 'escalation', icon: 'escalation' },
		{ label: 'app.bpmn-modeler.subtype.compensation', subType: 'compensation', icon: 'compensation' },
	],
	subProcess: [
		{ label: 'app.bpmn-modeler.subtype.collapsedSubProcess', subType: 'collapsed', icon: 'collapsed' },
		{ label: 'app.bpmn-modeler.subtype.expandedSubProcess', subType: 'expanded', icon: 'expanded' },
		{ label: 'app.bpmn-modeler.subtype.eventSubProcess', subType: 'event', icon: 'event' },
		{ label: 'app.bpmn-modeler.subtype.transaction', subType: 'transaction', icon: 'transaction' },
	],
};
