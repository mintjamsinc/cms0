...
> Status: **0.1.4-beta** — public preview. APIs, on-disk formats, and bundled
...
```bash
docker run --platform linux/amd64 ... mintjams/cms:0.1.4-beta
```
