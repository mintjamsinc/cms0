...
> Status: **0.1.12-beta** — public preview. APIs, on-disk formats, and bundled
...
services:
  cms:
    image: mintjams/cms:0.1.12-beta
...
```bash
docker run --platform linux/amd64 ... mintjams/cms:0.1.12-beta
```
